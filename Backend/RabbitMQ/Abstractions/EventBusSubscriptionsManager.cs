...
namespace RabbitMQ.Abstractions
{
    public partial class EventBusSubscriptionsManager : IEventBusSubscriptionsManager
    {
        ...
        public IEnumerable<SubscriptionInfo> GetHandlersForEvent<T>() where T : IntergrationEvent
        ...
        public bool HasSubscriptionsForEvent<T>() where T : IntergrationEvent => HasSubscriptionsForEvent(GetEventKey<T>());
